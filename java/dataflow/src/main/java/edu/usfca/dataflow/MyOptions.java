...
public interface MyOptions extends DataflowPipelineOptions {
  ...
  @Description("See YelpJob.")
  @Default.Float(3.5F)
  float getStandardOfGoodReview();

  void setStandardOfGoodReview(float star);

  // "--appCountThreshold=1234"
  @Description("See YelpJob.")
  @Default.Float(3.5F)
  float getStandardOfGoodBusiness();

  void setStandardOfGoodBusiness(float star);

  // "--geoCountThreshold=1234"
  @Description("See YelpJob.")
  @Default.Integer(100)
  int getNumOfGoodReview();

  void setNumOfGoodReview(int num);
