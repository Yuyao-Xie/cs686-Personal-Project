...
public class PathConfigs {
  ...
  public String getReadPathToReview() {
    return PATH_TO_RESOURCE_ROOT + "/review*";
  }

  public String getWritePathToCategory() {
    return PATH_TO_RESOURCE_ROOT + "/output/category";
  }

  public String getReadPathToBusiness() {
    return PATH_TO_RESOURCE_ROOT + "/business*";
  }
