...
import edu.usfca.dataflow.job.YelpJob;
...
public class Main {
  ...
  public final static String GCP_PROJECT_ID = "cs686-yuyao-xie"; // <- TODO change this to your GCP project ID.
  public final static String GCS_BUCKET = "gs://cs686-bucket1"; // <- TODO change this to your bucket (that you used
                                                                 // for project 4).
  public final static String REGION = "us-west1"; // Don't change this.

  public final static String MY_BQ_DATASET = "Project_03"; // <- TODO change this to an existing dataset in your BigQuery.
  public final static String MY_BQ_TABLE = "PP_table"; // <- this can be anything, and it'll be auto-created.
  ...
  public final static String LOCAL_PATH_TO_RESOURCE_DIR = "/home/yuyao/Downloads/Yelp-Project";
  ...
  public static void main(String[] args) {
    ...
    switch (job) {
      case "yelpJob": // Pipeline #1 for Task A
        options = setDefaultValues(options);
        YelpJob.execute(options);
        break;
